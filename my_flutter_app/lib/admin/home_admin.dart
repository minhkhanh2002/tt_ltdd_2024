...
import 'add_food.dart';
import 'admin_login.dart';
import 'order_manager.dart'; // Import Order Manager
import 'view_chats.dart'; // Import trang mới
                  ...
                  ListTile(
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                const ViewChats()), // Điều hướng tới trang ViewChats
                      );
                    },
                    leading: Icon(
                      Icons.chat,
                  ...
                  ListTile(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const OrderManager()),
                      );
                    },
                    leading: Icon(
                      Icons.shopping_cart,
                    ...
                    subtitle: const Text("Manage all customer orders."),
                    trailing: const Icon(Icons.arrow_forward_ios),
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(10.0),
                    ),
